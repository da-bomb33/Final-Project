...
<head>
    ...
    <script src = "starwarsjs.js"></script>
...
<body>
    ...
    <!-- Page Content -->
	<div class = "center">
	<h1>Start Wars Fansite</h1>
	<h4> This website is dedicated to all the fans of the star wars universe. <br>the websites goal is to give you the fans all the information you need to know about 
	 the star wars universe.</h4>
	<br>
	<br>
	<br>
	<p> Below you can search the database for information regarding the star wars universe!</p>
	<br>
	<br>
	<br>
